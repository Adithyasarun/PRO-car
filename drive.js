AFRAME.registerComponent('drive', {
    ...
    driveCar: function () {
        ...
        window.addEventListener('keydown', function (e) {
            ...
            var wheel = document.querySelector("#stWheel")
            ...
            if (e.code == "Space") {            
                ...
                var stopCar = document.querySelector("#bre")
        ...
        window.addEventListener('keyup', function (e) {
            ...
            if (e.code == "Space") {             
                var startCar = document.querySelector("#bre")
                startCar.setAttribute("material", "color", "gray")
                var carSpeed = document.querySelector("#speed")
                carSpeed.setAttribute("text", { value: "10" });
            }
